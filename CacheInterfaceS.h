...
//#define MMU_MAX_NUMBER_OF_THREADS  2	//Need to remove this from here later
//#define MMU_THREAD_MASK  (MMU_MAX_NUMBER_OF_THREADS-1) //Same here also
...
typedef struct _WriteThroughAllocateCache {
	...
	//        just fetch the word.)
    // For sitar implementation we don't need them to be arrays
    // Every CPU will have its own cache
